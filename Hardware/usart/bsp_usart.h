...
#define BSP_USART_RCU     RCU_USART5  // 串口0的时钟

#define BSP_USART_TX_PORT GPIOA				// 串口TX的端口
#define BSP_USART_RX_PORT GPIOA				// 串口RX的端口
#define BSP_USART_AF 			GPIO_AF_8   // 串口0的复用功能
#define BSP_USART_TX_PIN  GPIO_PIN_11  // 串口TX的引脚
#define BSP_USART_RX_PIN  GPIO_PIN_12 // 串口RX的引脚

#define BSP_USART 						USART5      								// 串口0
#define BSP_USART_IRQ     		USART5_IRQn 								// 串口0中断
#define BSP_USART_IRQHandler  USART5_IRQHandler						// 串口0中断服务函数
